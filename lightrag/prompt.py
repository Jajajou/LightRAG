...
<input>
<entity_type>{description_type}</entity_type>
<entity_name>{description_name}</entity_name>
<description_list>
{description_list}
</description_list>
</input>
...
<entry_format>
  Các mục trong danh sách tham chiếu tuân theo định dạng: `- [Tiêu đề Tài liệu](URL)`
  KHÔNG hiển thị `URL` thô; liên kết phải ẩn dưới tiêu đề.
...
- [Quy chế đào tạo đại học hệ chính quy](https://example.edu/regulation.pdf)
- [Hướng dẫn đăng ký học phần](https://example.edu/registration)
- [Quy định về học bổng khuyến khích học tập](https://example.edu/scholarship)
</references_example>
...
<entry_format>
  Các mục trong danh sách tham chiếu tuân theo định dạng:
  - `- [Tiêu đề Tài liệu](URL)`
  - Nếu không tìm thấy `URL`, chỉ xuất: `- Tiêu đề Tài liệu`.
  - KHÔNG hiển thị URL thô; liên kết phải ẩn dưới tiêu đề.
</entry_format>
